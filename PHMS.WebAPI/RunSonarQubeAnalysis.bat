...
dotnet sonarscanner begin /k:"PHMS.WebAPI" /d:sonar.host.url="http://localhost:9000" /d:sonar.token="sqp_831f2d6f94f1db83b97cb878823793019b24ba3f" /d:sonar.coverageReportPaths="TestResults/SonarQubeReport/sonarqube.xml"
IF ERRORLEVEL 1 (
